...
function cw_add_style(){
    function cw_addstyle(){
        ...
        wp_enqueue_script( 'cw-modal',plugin_dir_url(__DIR__).'admin/js/bootstrapjs.min.js');
        wp_enqueue_script( 'cw-jquery',plugin_dir_url(__DIR__).'admin/js/jquery.min.js');
